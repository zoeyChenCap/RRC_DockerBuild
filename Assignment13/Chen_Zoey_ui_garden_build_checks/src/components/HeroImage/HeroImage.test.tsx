...
describe('HeroImage Component', () => {
  ...
  test('renders without description when not provided', () => {
    render(<HeroImage imageUrl="https://example.com/test-image.jpg" heading="Only Heading" />);
  ...
  test('uses default alt text when not provided', () => {
    render(<HeroImage imageUrl="https://example.com/test-image.jpg" heading="Test Heading" />);
